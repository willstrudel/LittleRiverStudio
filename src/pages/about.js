    ...
    return (
        <div className="h-screen lg:grid bg-gray-500">
            <div className="relative h-64 w-26">
                <h1 className="absolute flex xl:left-56 xl:top-28 text-center sm:text-center inset-x-0 inset-y-4 xl:text-8xl md:text-7xl sm:text-6xl text-4xl uppercase font-black">About Me</h1>  
            </div>
