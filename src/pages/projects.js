    ...
    return (
        <div className="min-h-screen grid justify-center items-center bg-indigo-900 ">
            <div className="flex justify-center">
                <h1 className="flex justify-center uppercase font-black text-white text-6xl shadow-2xl md:text-7xl lg:text-7xl">Projects
                </h1>
            </div>

            <div className=" justify-center grid gap-6 lg:gap-52 sm:grid-cols-3 lg:grid-cols-3">     
